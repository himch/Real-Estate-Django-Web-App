...
class Article(models.Model):
    ...
    chapter_en = models.CharField(verbose_name='Chapter en', max_length=50)
    chapter_ru = models.CharField(verbose_name='Chapter ru', max_length=50)
    chapter_ar = models.CharField(verbose_name='Chapter ar', max_length=50)
